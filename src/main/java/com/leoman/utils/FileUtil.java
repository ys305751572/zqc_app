...
public class FileUtil {
    ...
    public static FileBo  save(MultipartFile file, String fileName) throws IOException{
        ...
        String uploadPath = UploadUtil.getImagesUpladPath() + "src/main/java/"; //生成日期目录 image/2014/7/21/
        String foreName = uploadPath+fileName;   //文件名称 image/2014/7/21/221144144554
        String desFilePathName = uploadPath+fileName;//完整文件名称 image/2014/7/21/221144144554.jpg
